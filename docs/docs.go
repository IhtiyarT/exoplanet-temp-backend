...
const docTemplate = `{
    ...
    "paths": {
        "/api/planet": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Поисковый запрос (по названию планеты)",
                        "name": "query",
                        "in": "query"
                    }
                ],
        ...
        "/api/planet-system/{system_id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ID планетной системы",
                        "name": "system_id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.PlanetSystemInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/planet-system/{system_id}/form": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/planet-system/{system_id}/moder": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.statusInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/planet-system/{system_id}/planets": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/planet/": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Данные для создания планеты",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.PlanetInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/planet/image/add/{planet_id}": {
            "post": {
        ...
        "/api/temperature-req/{system_id}/planet/{planet_id}": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Новое расстояние до планеты",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.UpdateDistanceInput"
                        }
                    }
                ],
                "responses": {
